<section id="special-price">
    <div class="container">
        ...
        <div id="filters" class="button-group text-end font-size-16">
            ...
            <button class="btn" data-filter=".Traditional">Traditional</button>
            <button class="btn" data-filter=".Snowskin">Snowskin</button>
        </div>
        <div class="product-filter">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    // Determine the category and set the class accordingly
                    $categoryClass = ($count < 2) ? 'Traditional' : 'Snowskin';
                    ?>
                    <div class="product-filter-item <?php echo $categoryClass; ?> border">
                        <div class="item py-2 border rounded-2 bg-light" style="width: 250px;">
                            <div class="product">
