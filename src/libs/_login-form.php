        ...
        <form method="POST" class="form" id="sign-in">
            <?php if ($_SESSION['logged'] == true) { ?>
                <h3>
                    Welcome back,
                    <span>
                        <?php echo $user = $acc->getAccount($_SESSION['userid'], 'users')['Username']; ?>!
                    </span>
                </h3>
                <h5 class="mb-2">
                    <strong>
                        <?php echo $user = $acc->getAccount($_SESSION['userid'], 'users')['Email']; ?>
                    </strong>
                </h5>
                <p class="text-muted">
                    Customer<br/>
                ...
                if ($_SESSION['OTPsent'] === False) { 
                    ...
                    echo '<form method="POST">
                        <div class="form-group" id="otp-group" style="padding:10px;margin-top:20px;">
                            ...
                            <button class="form-submit" type="submit" 
                            name="verify-otp-login">Verify OTP</button>
                        </div>
                    </form>';
                }
            }
