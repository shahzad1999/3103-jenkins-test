        ...
        <div class="row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="qty d-flex pt-2">
                                <div class="d-flex w-25">
                                    <input type="text" data-id="<?php echo $productItems['Quantity'] ?? '0'; ?>" class="qty_input text-center border px-2 w-100 bg-light" id="product-quantity" disabled value="<?php echo $productItems['Quantity']?>">
                                </div>
                                <form method="POST"> 
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    if ($subtotal >= 250) {
                        echo '<h6 class="font-size-12 text-success py-3"><i class="fas fa-check"></i><br>Your order is eligible for FREE Delivery.</h6>';
                    } else {
                        echo '<h6 class="font-size-12 text-danger py-3"><i class="fas fa-times"></i><br>Your order is NOT eligible for FREE Delivery.</h6>';
                    }
                    ?>
